...
function c77239265.initial_effect(c)
	...
	e0:SetProperty(EFFECT_FLAG_CANNOT_INACTIVATE+EFFECT_FLAG_CANNOT_NEGATE+EFFECT_FLAG_CANNOT_DISABLE)
...
function c77239265.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	or Duel.IsExistingMatchingCard(c77239264.filter13,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED+LOCATION_EXTRA,0,1,nil)
	or Duel.IsExistingMatchingCard(c77239264.filter14,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED+LOCATION_EXTRA,0,1,nil) 
	end

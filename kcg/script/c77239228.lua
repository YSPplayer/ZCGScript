...
function c77239228.target(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
        and Duel.IsExistingMatchingCard(c77239228.filter,tp,LOCATION_HAND+LOCATION_DECK,0,1,nil,e,tp) end
...
function c77239228.operation(e,tp,eg,ep,ev,re,r,rp)
    ...
    local g=Duel.SelectMatchingCard(tp,c77239228.filter,tp,LOCATION_HAND+LOCATION_DECK,0,1,ft,nil,e,tp)

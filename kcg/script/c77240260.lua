--奥利哈刚 元素召唤者 （ZCG）
function c77240260.initial_effect(c)
--SpecialSummon
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(77240260,0))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetTarget(c77240260.target)
	e4:SetOperation(c77240260.activate)
	c:RegisterEffect(e4)
end
function c77240260.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c77240260.activate(e,tp,eg,ep,ev,re,r,rp)

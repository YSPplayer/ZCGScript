...
function s.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(s.spfilter,c:GetControler(),LOCATION_GRAVE,0,10,nil)
end
function s.atkfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0xa210) and c:IsLevelAbove(1)
end

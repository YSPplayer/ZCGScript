...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(s.tdfilter2,tp,0,LOCATION_SZONE,1,nil) end
	e:GetHandler():RegisterFlagEffect(id,0,0,1)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,s.tdfilter2,tp,0,LOCATION_SZONE,1,1,nil)

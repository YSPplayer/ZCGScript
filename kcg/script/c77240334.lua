...
ovc=mog:GetNext()
   ...
   if #mog>0 then Duel.Exile(mog,REASON_RULE) end
   end
   local mNum=1
...
ovc2=eog:GetNext()
   ...
   if #eog>0 then Duel.Exile(eog,REASON_RULE) end
   end
   local mNum=1
...
ovc3=mzg:GetNext()
   ...
   if #mzg>0 then Duel.Exile(mzg,REASON_RULE) end
   end
   local mNum=1
...
ovc4=ezg:GetNext()
   ...
   if #ezg>0 then Duel.Exile(ezg,REASON_RULE) end
   end
   local mNum=1

...
function s.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsPlayerCanSpecialSummonMonster(tp,77240543,0,TYPES_TOKEN_MONSTER,0,0,1,RACE_DIVINE,ATTRIBUTE_DIVINE) then
		local token=Duel.CreateToken(tp,77240543)
...
function s.spcon(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		and Duel.GetFieldGroupCount(c:GetControler(),LOCATION_MZONE,0,nil)==0 and Duel.GetFieldGroupCount(c:GetControler(),0,LOCATION_MZONE,nil)>0
end

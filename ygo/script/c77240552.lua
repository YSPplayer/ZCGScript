...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and (Duel.GetCurrentPhase()>=PHASE_BATTLE_START and Duel.GetCurrentPhase()<=PHASE_BATTLE) and Duel.GetTurnPlayer()==tp and Duel.IsChainNegatable(ev)
end 

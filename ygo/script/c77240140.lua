...
function c77240140.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(77240140,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_DESTROYED)
	e2:SetCondition(c77240140.dmcon)
...
--negate
	...
	e0:SetCondition(c77240140.negcon)
	e0:SetTarget(c77240140.negtg)
	e0:SetOperation(c77240140.negop)
	c:RegisterEffect(e0)
end
function c77240140.negcon(e,tp,eg,ep,ev,re,r,rp)
...
function c77240140.negtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c77240140.negop(e,tp,eg,ep,ev,re,r,rp)
...
function c77240140.dmcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsReason(REASON_BATTLE)
end
function c77240140.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>2
		and Duel.IsExistingMatchingCard(c77240140.filter,tp,LOCATION_HAND,0,3,nil,e,tp) end
...
function c77240140.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c77240140.filter,tp,LOCATION_HAND,0,3,3,nil,e,tp)

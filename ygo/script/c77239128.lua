...
function c77239128.initial_effect(c)
   ...
   -- Fusion.AddProcCode2(c,89631139,46986414,false,false)
	...
	aux.AddFusionProcCode2(c,89631139,46986414,false,false)
	aux.AddContactFusionProcedure(c,Card.IsAbleToDeckOrExtraAsCost,LOCATION_ONFIELD+LOCATION_HAND,0,aux.tdcfop(c))

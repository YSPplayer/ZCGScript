...
function s.initial_effect(c)
	...
	e3:SetCategory(EFFECT_FLAG_CANNOT_DISABLE)
...
return Duel.GetLP(tp)~=lp77240576 
end
function s.addc(e,tp,eg,ep,ev,re,r,rp)
		 local res= lp77240576
		 lp77240576=Duel.GetLP(tp)
		 if res>lp77240576 then --dis 
			s.dis=true 
			s.s=false
		 elseif res<lp77240576 then --s
			s.dis=false 
			s.s=true
		else
		s.dis=false 

...
function s.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(77239230,0))
  ...
  --immune spell
	...
	e3:SetDescription(aux.Stringid(77239230,1))
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
		local g=Duel.CreateToken(tp,77239269)
		Duel.SendtoHand(g,nil,REASON_EFFECT)
		Duel.ConfirmCards(1-tp,g)
end
function s.efilter(e,te)
	return te:GetOwner()~=e:GetOwner() and not te:GetOwner():IsCode(77239292)   
end

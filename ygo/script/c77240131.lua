--天龙 追风龙
function c77240131.initial_effect(c)
	--Search
    ...
    e1:SetCountLimit(1)
    e1:SetCondition(c77240131.thcon)
    e1:SetOperation(c77240131.thop)
    c:RegisterEffect(e1)
    ...
    e52:SetOperation(c77240131.disop2)
    ...
    e53:SetTarget(c77240131.distg2)
    ...
    e54:SetTarget(c77240131.distg2)
    c:RegisterEffect(e54)
end
function c77240131.thcon(e,tp,eg,ep,ev,re,r,rp)
...
function c77240131.thop(e,tp,eg,ep,ev,re,r,rp)
    if Duel.Destroy(e:GetHandler(),REASON_EFFECT) then
        Duel.Draw(tp,2,REASON_EFFECT)
    end
end

function c77240131.disop2(e,tp,eg,ep,ev,re,r,rp)

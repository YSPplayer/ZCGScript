...
function s.initial_effect(c)
 ...
 aux.AddFusionProcCodeFun(c,77240361,s.ofilter,1,true,true)
aux.AddContactFusionProcedure(c,s.cfilter,LOCATION_ONFIELD+LOCATION_HAND,0,Duel.SendtoGrave,REASON_COST+REASON_MATERIAL)
	-- attackall
